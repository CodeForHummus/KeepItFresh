...
//        canvas.drawText(mText.getValue(),rect.centerX(), rect.centerY(), sTextPaint);
        List<? extends Text> textComponents = mText.getComponents();
        for (Text component: textComponents){
            float left = translateX(component.getBoundingBox().left);
            float bottom = translateY(component.getBoundingBox().bottom);
            canvas.drawText(component.getValue(), left, bottom, sTextPaint);
        }
    }
}
